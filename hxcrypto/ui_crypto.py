...
class Ui_Crypto(object):
    def setupUi(self, Crypto):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=Crypto)
        ...
        self.pubkeyButton = QtWidgets.QPushButton(parent=self.tab_1)
        self.pubkeyButton.setObjectName("pubkeyButton")
        self.verticalLayout_4.addWidget(self.pubkeyButton)
        self.horizontalLayout_3.addLayout(self.verticalLayout_4)
        self.resetPrivateButton = QtWidgets.QPushButton(parent=self.tab_1)
        ...
        self.otherKeyEdit = QtWidgets.QLineEdit(parent=self.tab_1)
        self.otherKeyEdit.setObjectName("otherKeyEdit")
        self.verticalLayout_6.addWidget(self.otherKeyEdit)
        self.horizontalLayout_5.addLayout(self.verticalLayout_6)
        self.resetExchangeButton = QtWidgets.QPushButton(parent=self.tab_1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(30)
        sizePolicy.setVerticalStretch(0)
        ...
        self.textEdit = QtWidgets.QPlainTextEdit(parent=self.tab_1)
        ...
        self.encryptButton = QtWidgets.QPushButton(parent=self.tab_1)
        self.encryptButton.setObjectName("encryptButton")
        self.horizontalLayout.addWidget(self.encryptButton)
        self.decryptButton = QtWidgets.QPushButton(parent=self.tab_1)
        ...
        self.pskEdit = QtWidgets.QLineEdit(parent=self.tab_2)
        self.pskEdit.setEchoMode(QtWidgets.QLineEdit.EchoMode.PasswordEchoOnEdit)
        self.pskEdit.setObjectName("pskEdit")
        self.verticalLayout_3.addWidget(self.pskEdit)
        self.psktextEdit = QtWidgets.QPlainTextEdit(parent=self.tab_2)
        ...
        self.PSKencryptButton = QtWidgets.QPushButton(parent=self.tab_2)
        self.PSKencryptButton.setObjectName("PSKencryptButton")
        self.horizontalLayout_2.addWidget(self.PSKencryptButton)
        self.PSKdecryptButton = QtWidgets.QPushButton(parent=self.tab_2)
        ...
        self.b64comboBox = QtWidgets.QComboBox(parent=self.tab)
        self.b64comboBox.setObjectName("b64comboBox")
        self.verticalLayout_5.addWidget(self.b64comboBox)
        self.b64TextEdit = QtWidgets.QPlainTextEdit(parent=self.tab)
        self.b64TextEdit.setObjectName("b64TextEdit")
        self.verticalLayout_5.addWidget(self.b64TextEdit)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.b64EncodeButton = QtWidgets.QPushButton(parent=self.tab)
        self.b64EncodeButton.setObjectName("b64EncodeButton")
        self.horizontalLayout_4.addWidget(self.b64EncodeButton)
        self.b64DecodeButton = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.statusBar = QtWidgets.QStatusBar(parent=Crypto)
